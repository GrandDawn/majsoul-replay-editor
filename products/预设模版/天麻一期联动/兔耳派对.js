...
player_datas[0].nickname = '宫永咲-兔耳派对';
player_datas[1].nickname = '原村和-兔耳派对';
player_datas[2].nickname = '天江衣-兔耳派对';
player_datas[3].nickname = '宫永照-兔耳派对';
player_datas[0].avatar_id = 403404;
player_datas[1].avatar_id = 403504;
