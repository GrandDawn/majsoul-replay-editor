...
player_datas[0].nickname = '蛇喰梦子-百花';
player_datas[1].nickname = '早乙女-百花';
player_datas[2].nickname = '生志摩妄-百花';
player_datas[3].nickname = '桃喰绮罗莉-百花';
player_datas[0].avatar_id = 404003;
player_datas[1].avatar_id = 404103;
