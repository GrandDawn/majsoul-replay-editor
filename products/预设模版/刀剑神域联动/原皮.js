...
player_datas[0].nickname = '桐人';
player_datas[1].nickname = '亚丝娜';
player_datas[2].nickname = '莉法';
player_datas[3].nickname = '诗乃';
player_datas[0].avatar_id = 40012201;
player_datas[1].avatar_id = 40012301;
player_datas[2].avatar_id = 40012401;
player_datas[3].avatar_id = 40012501;
