...
player_datas[0].nickname = '四宫辉夜-怪盗';
player_datas[1].nickname = '白银御行-怪盗';
player_datas[2].nickname = '早坂爱-怪盗';
player_datas[3].nickname = '白银圭-怪盗';
player_datas[0].avatar_id = 405503;
player_datas[1].avatar_id = 405603;
