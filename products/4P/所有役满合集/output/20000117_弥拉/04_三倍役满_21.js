...
player_datas[0].nickname = '弥拉-契约';
player_datas[1].nickname = '弥拉';
player_datas[2].nickname = '弥拉-契约';
player_datas[3].nickname = '弥拉';
player_datas[0].avatar_id = 40011702;
player_datas[1].avatar_id = 40011701;
player_datas[2].avatar_id = 40011702;
player_datas[3].avatar_id = 40011701;
