...
player_datas[0].nickname = '亚丝娜-契约';
player_datas[1].nickname = '亚丝娜';
player_datas[2].nickname = '亚丝娜-契约';
player_datas[3].nickname = '绀碧之界';
player_datas[0].avatar_id = 40012302;
player_datas[1].avatar_id = 40012301;
player_datas[2].avatar_id = 40012302;
player_datas[3].avatar_id = 40012303;
